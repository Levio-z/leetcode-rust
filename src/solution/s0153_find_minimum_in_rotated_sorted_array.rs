...
/// in the array [a[n-1], a[0], a[1], a[2], ..., a[n-2]]. Given the sorted
/// rotated array nums of unique elements, return the minimum element of this
...
mod tests {
    ...
    #[test]
    fn test_153_example1() {
        assert_eq!(Solution::find_min(vec![3, 4, 5, 1, 2]), 1);
    }

    #[test]
    fn test_153_example2() {
        assert_eq!(Solution::find_min(vec![4, 5, 6, 7, 0, 1, 2]), 0);
    }

    #[test]
    fn test_153_example3() {
        assert_eq!(Solution::find_min(vec![11, 13, 15, 17]), 11);
    }

    #[test]
    fn test_153_single_element() {
        assert_eq!(Solution::find_min(vec![1]), 1);
    }

    #[test]
    fn test_153_no_rotation() {
        assert_eq!(Solution::find_min(vec![1, 2, 3, 4, 5]), 1);
    }

    #[test]
    fn test_153_two_elements() {
        assert_eq!(Solution::find_min(vec![2, 1]), 1);
    }

    #[test]
    fn test_153_rotated_once() {
        assert_eq!(Solution::find_min(vec![2, 3, 4, 5, 1]), 1);
    }

    #[test]
    fn test_153_rotated_at_end() {
        assert_eq!(Solution::find_min(vec![2, 3, 4, 5, 6, 7, 0, 1]), 0);
    }
}
