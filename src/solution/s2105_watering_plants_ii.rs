...
/// the i^th plant is located at x = i. Each plant needs a specific amount of
...
/// water it needs. 	Alice/Bob must water the plant if they have enough in their
/// can to fully water it. Otherwise, they first refill their can
/// (instantaneously) then water the plant. 	In case both Alice and Bob reach
/// the same plant, the one with more water currently in his/her watering can
/// should water this plant. If they have the same amount of water, then Alice
/// should water this plant.
///
