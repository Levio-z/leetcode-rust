...
/// neighbors becomes a live cell, as if by reproduction. </ol>
///
/// Write a function to compute the next state (after one update) of the board
/// given its current state. <span>The next state is created by applying the
/// above rules simultaneously to every cell in the current state, where births
/// and deaths occur simultaneously.</span>
///
/// Example:
///
///
...
/// values to update other cells.     In this question, we represent the board
/// using a 2D array. In principle, the board is infinite, which would cause
/// problems when the active area encroaches the border of the array. How would
/// you address these problems? </ol>
///
pub struct Solution {}
