...
/// minimal length of a contiguous subarray of which the sum &ge; s. If there
...
///
/// <div class="spoilers">If you have figured out the O(n) solution, try coding
/// another solution of which the time complexity is O(n log n). </div>
///
pub struct Solution {}
