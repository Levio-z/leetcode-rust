...
///
/// Given a non-negative index k where k &le; 33, return the k^th index row of
/// the Pascal's triangle.
///
/// Note that the row index starts from 0.
///
/// <img alt="" src="https://upload.wikimedia.org/wikipedia/commons/0/0d/PascalTriangleAnimated2.gif" /><br />
/// <small>In Pascal's triangle, each number is the sum of the two numbers
/// directly above it.</small>
///
/// Example:
///
///
