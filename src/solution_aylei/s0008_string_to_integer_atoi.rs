...
///
/// <ul>
///     <li>Only the space character <code>&#39; &#39;</code> is considered as
/// whitespace character.</li>     <li>Assume we are dealing with an environment
/// which could only store integers within the 32-bit signed integer range:
/// [-2^31,  2^31 - 1]. If the numerical value is out of the range of
/// representable values, INT_MAX (2^31 - 1) or INT_MIN (-2^31) is
/// returned.</li> </ul>
///
/// Example 1:
///
...
/// a numerical              digit or a +/- sign. Therefore no valid conversion
/// could be performed.
///
/// Example 5:
///
