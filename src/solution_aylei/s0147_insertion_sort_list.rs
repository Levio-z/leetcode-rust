...
/// <small>A graphical example of insertion sort. The partial sorted list
/// (black) initially contains only the first element in the list.<br />
/// With each iteration one element (red) is removed from the input data and
/// inserted in-place into the sorted list</small><br />
///
///
/// <ol>
/// </ol>
