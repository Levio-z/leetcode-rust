...
/// id="example-input-1-2">3</span> Output: <span
/// id="example-output-1">true</span>
///
///
/// <div>
/// Example 2:
...
/// id="example-input-2-2">1</span> Output: <span
/// id="example-output-2">true</span>
///
///
/// <div>
/// Example 3:
///
///
/// Input: nums = <span id="example-input-3-1">[1,2,3,1,2,3]</span>, k = <span
/// id="example-input-3-2">2</span> Output: <span
/// id="example-output-3">false</span>
///
/// </div>
/// </div>
/// </div>
