...
///
///
/// Input: A = <span id="example-input-1-1">-3</span>, B = <span
/// id="example-input-1-2">0</span>, C = <span id="example-input-1-3">3</span>,
/// D = <span id="example-input-1-4">4</span>, E = <span
/// id="example-input-1-5">0</span>, F = <span id="example-input-1-6">-1</span>,
/// G = <span id="example-input-1-7">9</span>, H = <span
/// id="example-input-1-8">2</span> Output: <span
/// id="example-output-1">45</span>
///
/// Note:
///
