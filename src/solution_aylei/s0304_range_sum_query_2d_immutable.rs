...
///
///
/// <img src="/static/images/courses/range_sum_query_2d.png" border="0"
/// alt="Range Sum Query 2D" /><br /> <small>The above rectangle (with the red
/// border) is defined by (row1, col1) = (2, 1) and (row2, col2) = (4, 3), which
/// contains sum = 8.</small>
///
///
/// Example:<br>
///
